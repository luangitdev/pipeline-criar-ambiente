...
update parametro set valor = 'http://10.0.0.70:8040/kettle' where chave = 'Kettle-URL';
...
update parametro set valor = '10.0.1.245' where chave = 'Servidor Banco de Dados';
update parametro set valor = 'http://10.0.0.192:8081' where chave = 'Url Routes Api';
...
update parametro set valor='http://10.0.0.36:9081/ptfses4-13-1' where chave='Url Roteirizador' or chave='Url Roteirizador Reprocessar';
